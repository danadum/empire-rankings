        ...
        <div
            ...
            <div v-if="!this.show_settings">
                <button
                    ...
                    aria-label="Settings">
                    <div class="bg-current [mask-image:url(/src/assets/icons/settings.svg)]">
                        <img src="/src/assets/icons/settings.svg" alt="Settings" class="h-6 opacity-0" />
                    </div>
                </button>
            </div>
            ...
            <div
                ...
                <button
                    ...
                    aria-label="Close">
                    <div class="bg-current [mask-image:url(/src/assets/icons/close.svg)]">
                        <img src="/src/assets/icons/close.svg" alt="Close" class="h-4 opacity-0" />
                    </div>
                </button>
                    ...
                    <ul class="flex flex-col grow space-y-2 font-medium">
                        ...
                        <li>
                            <ToggleInput
                                ...
                                :choices="[
                                    { text: '', icon: '/src/assets/icons/sun.svg' },
                                    { text: '', icon: '/src/assets/icons/moon.svg' },
                                ]" />
                        </li>
                        <li>
                            <ToggleInput
                                ...
                                :change="toggleGame"
                                :choices="[
                                    { text: 'GGE', icon: '/src/assets/icons/laptop.svg' },
                                    { text: 'E4K', icon: '/src/assets/icons/mobile.svg' },
                                ]" />
                        </li>
                        <li class="!mt-auto">
            ...
            <img
                :src="`/src/assets/images/logo-${this.game}.png`"
                alt="Game logo"
            ...
            <div class="flex flex-wrap mx-1.5 bg-gray-100 dark:bg-neutral-700 rounded-lg">
                ...
                <ToggleInput
                    ...
                    :choices="[
                        { text: this.texts.player, image: '/src/assets/images/player.png' },
                        { text: this.texts.dialog_alliance_name_default, image: '/src/assets/images/alliance.png' },
                    ]" />
            </div>
                            ...
                            <div v-if="this.nbCategories > 1 || this.current_category_index < 0" class="py-1 px-4">
                                <nav class="flex items-center justify-center space-x-1" aria-label="Category">
                                    <button
                                        ...
                                        aria-label="Previous">
                                        <div
                                            class="bg-current -rotate-90 rtl:rotate-90 [mask-image:url(/src/assets/icons/arrow_up.svg)]">
                                            <img
                                    ...
                                    <button
                                        ...
                                        aria-label="Download">
                                        <div class="bg-current [mask-image:url(/src/assets/icons/download.svg)]">
                                            <img
                                ...
                                <table class="grow divide-y divide-gray-200 dark:divide-neutral-700">
                                    ...
                                    <tbody class="relative" v-if="!this.players?.length">
                                        ...
                                        <div
                                            ...
                                            <div
                                                class="w-fit m-auto bg-current [mask-image:url(/src/assets/icons/error.svg)]">
                                                <img
                                        ...
                                        <tr
                                            ...
                                            <td
                                                ...
                                                <button
                                                    ...
                                                    <div
                                                        ...
                                                        class="bg-current [mask-image:url(/src/assets/icons/view.svg)]">
                                                        <img
                                            ...
                                            <td
                                                ...
                                                <img
                                                    ...
                                                    :src="
                                                        '/src/assets/images/title_level_' +
                                            ...
                                            <td
                                                ...
                                                <div class="space-x-2">
                                                    <div
                                                        ...
                                                        <img
                                                            src="/src/assets/images/medal_gold.png"
                                                            alt="Gold medal"
                                                    ...
                                                    <div
                                                        ...
                                                        <img
                                                            src="/src/assets/images/medal_silver.png"
                                                            alt="Silver medal"
                                                            class="h-4 inline-block" />
                                                    </div>
                                                    <div
                                                        ...
                                                        <img
                                                            src="/src/assets/images/medal_bronze.png"
                                                            alt="Bronze medal"
                                                            class="h-4 inline-block" />
                                                    </div>
                                                </div>
                            ...
                            <div class="py-3 px-4 flex flex-wrap justify-center gap-y-1">
                                <div class="relative max-w-xs mx-auto">
                                    ...
                                    <div
                                        ...
                                        @click="this.search">
                                        <div class="bg-current [mask-image:url(/src/assets/icons/search.svg)]">
                                            <img
                                ...
                                <nav class="flex items-center space-x-1" aria-label="Pagination">
                                    <button
                                        ...
                                        aria-label="First">
                                        <div
                                            class="bg-current -rotate-90 rtl:rotate-90 [mask-image:url(/src/assets/icons/double_arrow_up.svg)]">
                                            <img
                                                src="/src/assets/icons/double_arrow_up.svg"
                                                alt="First page"
                                                class="h-4 opacity-0" />
                                        </div>
                                    </button>
